...
class Neo4jContainerTest {
    ...
    companion object {
        private const val adminPassword = "testpassword"

        @Container
        @JvmStatic
        val neo4j = Neo4jContainer("neo4j:5.26")
            .withAdminPassword(adminPassword)
    }

    @Test
    fun `can write and read data`() {
        GraphDatabase.driver(neo4j.boltUrl, AuthTokens.basic("neo4j", adminPassword)).use { driver ->
            ...
            val names = driver.executableQuery(
                """
